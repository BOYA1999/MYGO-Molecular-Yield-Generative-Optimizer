...
# from utils.difflinker_decom import fragment_by_brics  # Removed for SBDD-only version
...
def decompose_brics(mol, num_frags, min_frag_size):
    # Fragment by BRICS functionality removed for SBDD-only version
    # Use utils.graph_decom.decompose_brics instead for basic BRICS decomposition
    return []
