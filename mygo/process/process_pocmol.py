...
if __name__ == '__main__':
    ...
    if db_name == 'apep':
        ...
        # data dir
        pockets_dir = f'data/data_train/{db_name}/files/pockets10'
        mols_dir = f'data/data_train/{db_name}/files/mols'
        save_path = f'data/data_train/{db_name}/lmdb/pocmol10.lmdb'
        # df dir
        df_use = pd.read_csv(f'data/data_train/{db_name}/dfs/meta_filter_w_pocket.csv')
    # elif db_name == 'pepbdb':
        #
