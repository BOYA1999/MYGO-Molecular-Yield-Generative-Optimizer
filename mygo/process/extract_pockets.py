...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_df', type=str, default=None, help='Path to meta CSV file')
    parser.add_argument('--root', type=str, default=None, help='Root directory of data files')
    ...
    if db_name == 'apep':
        ...
        path_df = args.path_df or f'./data_train/{db_name}/dfs/meta_filter_w_pocket.csv'
        root = args.root or f'./data_train/{db_name}/files'
        proteins_dir = 'proteins'
        protein_name_appendix = '_pro.pdb'
